...
public class GreetingAspect {
    ...
    @Before("GreetingServicePointCuts.greetingFooPointcut()") //any return
    ...
    @AfterReturning("GreetingServicePointCuts.greetingFooPointcut()") //any return
    ...
    @AfterThrowing("GreetingServicePointCuts.greetingFooPointcut()") //any return
    ...
    @Around("GreetingServicePointCuts.greetingFooPointcut()") //any return
